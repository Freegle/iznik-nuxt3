<template>
  <client-only>
    <b-container fluid class="p-0 p-xl-2 bg-white">
      ...
      <b-row class="m-0">
        <b-col cols="0" lg="3" class="p-0 pe-1"> </b-col>
        <b-col cols="12" lg="6" class="p-0">
          <p>
            This is a test page for Magnite. There is one ad, below here, which
            is configured only to prebid via Magnite.
          </p>
          <ExternalDa
        ...
        <b-col cols="0" lg="3" class="p-0 ps-1"> </b-col>
      </b-row>
    </b-container>
  </client-only>
</template>
