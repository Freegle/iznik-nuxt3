            ...
            <b-card-body>
              <b-card-text>
                ...
                <p>
                  ...
                  Other people would like things they don't have. We match them
                  up. We don't have physical premises, or warehouses - people
                  give things directly to each other.
                </p>
          ...
          >
            <b-card-body>
              <b-card-text>
                ...
                <ul>
                  <li>
                    Many of us are passionate about the environment - and reuse
                    means we make and destroy less stuff.
                  </li>
                  <li>
        ...
        <b-card no-body class="mb-1">
          ...
          >
            <b-card-body>
              <b-card-text>
                <p>
                  <strong>Freegle is free to use, but not free to run.</strong>
                  We provide a free service, and keep costs
                  <em>phenomenally</em> low thanks to our large number of
                  committed volunteers -
                  <strong
                    >our annual budget averages around £80,000 each year</strong
                  >
                ...
                <p>
                  ...
                  life-threatening conditions, all of them competing for charity
                  funding. It usually goes to bigger charities than us doing
                  more important work, so we currently rely on voluntary
        ...
        <b-card no-body class="mb-1">
          ...
          >
            <b-card-body>
              <b-card-text>
                <p>
                  Freegle is a UK-wide umbrella organisation, formed in 2009 by
                  experienced volunteers and members of the free reuse
                ...
                <p>
                  ...
                  Freegle Ltd is a Registered Society (previously known as an
                  Industrial and Provident Society for Community Benefit).
                  Freegle Ltd is owned and governed by its members. Local and
                ...
                <p>
                  ...
                  <ExternalLink
                    ...
                    >here</ExternalLink
                  >
                  ). Instead they register with the Financial Conduct Authority
                  (our registration number is
                  <ExternalLink
                    href="https://mutuals.fca.org.uk/Search/Society/9593"
                    >32410R</ExternalLink
                  >
                  ) and also register with HMRC as charitable (our reference is
                  XT32865). So we're legally a charity, and can claim Gift Aid
                  if you
