    ...
    <div class="d-flex justify-content-center">
      <div class="privacy__container px-3 bg-white">
        ...
        <ul>
          ...
          <li>
            We use Google and Facebook's code to allow you to log in. They store
            a few third-party cookies, of their own, but before you've logged in
            they don't know who you are. If you are concerned about these, you
            can install a privacy blocker such as
            <!-- eslint-disable-next-line -->
