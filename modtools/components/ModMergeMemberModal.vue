<template>
  <div>
    <b-modal ref="modal" id="addMemberModal" title="Merge Member" size="lg" no-stacking @shown="onShow" @hidden="onHide">
      <template #default>
        <div v-if="merged">
          We've merged them.
        </div>
        <div v-else>
          ...
          <div v-if="byemail">
            ...
            <div class="d-flex justify-content-between flex-wrap">
              <b-form-input v-model="email1" type="email" placeholder="First email" class="mt-2 mb-2" />
              <b-form-input v-model="email2" type="email" placeholder="Second email (and email of merged user)" class="mt-2 mb-2" />
            </div>
          </div>
          <div v-else>
            <p class="mt-2">
            ...
            <div class="d-flex justify-content-between flex-wrap">
              <b-form-input v-model="id1" type="number" placeholder="First user id" class="mt-2 mb-2" />
              <b-form-input v-model="id2" type="number" placeholder="Second user id" class="mt-2 mb-2" />
            </div>
          </div>
          <b-form-input v-model="reason" placeholder="Enter a reason for the logs" class="mt-2 mb-2" />
