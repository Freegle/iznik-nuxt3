  ...
  <div v-if="!hide">
    <b-row>
      <b-col cols="6" md="3" class="pl-3">
        <div>
          ...
          <NoticeMessage v-else variant="danger">
            ...
            You can't approve this until it's linked to a donation - but you could click Give Up if you can't manage to.
          </NoticeMessage>
      ...
      <b-col cols="6" md="5">
        ...
        <b-form-input v-model="giftaid.housenameornumber" :class="{ 'border-danger': houseInvalid, 'mt-1': true }"
      ...
      <b-col cols="6" md="4" class="">
        ...
        <SpinButton variant="success" icon-name="check" label="Looks Good" @handle="reviewed"
          :disabled="houseInvalid || postcodeInvalid || nameInvalid || !giftaid.donations" />
      </b-col>
    </b-row>
    <b-row>
      <b-col>
