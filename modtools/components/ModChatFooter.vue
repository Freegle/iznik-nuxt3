    ...
    <div>
      ...
      <div v-else-if="showNotices && noticesToShow" class="d-flex">
        <div class="flex-grow-1">
          ...
          >
            <p>
              <v-icon icon="exclamation-triangle" />&nbsp;This member has a lot
              of thumbs down ratings. That might not be their fault, but please
              make very clear arrangements. If you have a good experience with
              them, give them a thumbs up.
            </p>
            <UserRatings
              v-if="chat.otheruid"
              :id="chat.otheruid"
...
import { setupChatMT } from '~/modtools/composables/useChatMT'
...
const dontHideNotices = ref(false)
...
// MT: Fetch the user1 (member) for MT-specific modals
