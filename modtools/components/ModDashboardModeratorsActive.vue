      ...
      <div v-else-if="ModeratorsActive && ModeratorsActive.length">
        ...
        <b-card no-body>
          <b-card-body>
            ...
            <b-button v-if="ModeratorsActive.length > 10 && !ModeratorsExpanded" variant="link" @click="ModeratorsExpanded = true">
              Show more...
            </b-button>
            <b-button v-if="ModeratorsActive.length > 10 && ModeratorsExpanded" variant="link" @click="ModeratorsExpanded = false">
              Show fewer...
            </b-button>
          </b-card-body>
        </b-card>
