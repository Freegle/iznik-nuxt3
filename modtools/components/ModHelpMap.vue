<template>
  <NoticeMessage v-if="showHelp" variant="info" class="mt-2 mb-2">
    ...
    <ul>
      ...
      <li>Click on an existing area to select it. If one is hidden below another, change the shape of the one on top, save it, then click the one
        underneath, then change the shape back afterwards.</li>
      <li>Once selected you'll see little dots appear which you can then drag to edit - then Save.</li>
      ...
      <li>CGA and DPA polygons cannot be changed here - use Settings->Group->Mapping.</li>
    </ul>
  </NoticeMessage>
