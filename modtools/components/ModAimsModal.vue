  ...
  <div>
    ...
    <b-modal ref="modal" id="aboutmemodal" title="Freegle Aims" size="lg" no-stacking>
      <template #default>
        ...
        <p class="mt-2">
          Thanks for volunteering for Freegle. Freegle is run nationally and in local Communities by volunteers. Here's what nationally and locally we
          aim to do and how we all can work to make Freegle good for us and members.
        </p>
        <h3>
        ...
        <ul>
          ...
          <li>Providing support for all aspects of running a Community by using email communications, national discussion forums and the Freegle wiki.
          </li>
          ...
          <li>Supporting all volunteers regardless of race, gender, age, sexuality, disability, religion, political belief, ethnic origin, marital
            status or nationality.</li>
        ...
        <ul>
          ...
          <li>Moderating their Community using Modtools, working with fellow volunteers to ensure that their Community is moderated at least daily, 7
            days a week.</li>
