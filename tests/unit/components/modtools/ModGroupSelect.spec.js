...
describe('ModGroupSelect', () => {
  ...
  describe('Props', () => {
    ...
    it('accepts labelSrOnly prop with default false', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('labelSrOnly')).toBe(false)
    })

    it('accepts modelValue prop with default 0', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('modelValue')).toBe(0)
    })

    it('accepts all prop with default false', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('all')).toBe(false)
    })

    it('accepts allMy prop with default true', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('allMy')).toBe(true)
    })

    it('accepts listall prop with default false', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('listall')).toBe(false)
    })

    it('accepts systemwide prop with default false', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('systemwide')).toBe(false)
    })

    it('accepts modonly prop with default false', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('modonly')).toBe(false)
    })

    it('accepts active prop with default false', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('active')).toBe(false)
    })

    it('accepts size prop with default md', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('size')).toBe('md')
    })

    it('accepts work prop with default empty array', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('work')).toEqual([])
    })

    it('accepts restrict prop with default true', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('restrict')).toBe(true)
    })

    it('accepts remember prop with default null', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('remember')).toBe(null)
    })
    ...
    it('accepts customName prop with default null', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('customName')).toBe(null)
    })

    it('accepts customVal prop with default null', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('customVal')).toBe(null)
    })

    it('accepts urlOverride prop with default false', () => {
      const wrapper = mountComponent()
      expect(wrapper.props('urlOverride')).toBe(false)
    })
  })
