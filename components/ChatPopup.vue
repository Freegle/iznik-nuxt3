          ...
          <div class="shadow chatHolder w-100">
            <div v-if="chat" class="chatTitle flex-shrink-0">
              ...
              <ratings
                v-if="otheruser"
                :id="otheruser.id"
                :key="'otheruser-' + (otheruser ? otheruser.id : null)"
                size="sm"
                class="pl-1 pt-1"
              />
            ...
            <div class="chatFooter flex-shrink-0">
              <p
                ...
                class="bg-danger white p-2 mb-0"
              >
                This person has been reported as a spammer or scammer. Please do
                not talk to them and under no circumstances send them any money.
                Do not arrange anything by courier.
              </p>
              <div
                v-if="
                  showNotices &&
              ...
              <div v-if="!spammer" class="pt-1 pb-1">
                ...
                <b-button
                  v-b-tooltip.hover.top
                  variant="secondary"
                  title="Info about this freegler"
                  @click="showInfo"
                >
