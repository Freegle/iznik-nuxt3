<template>
  <b-card
    bg-variant="white"
    border-variant="grey"
    :class="'forcebreak clickme ' + (size === 'md' ? '' : 'p-1')"
    no-body
    @click="open"
  >
    <b-card-body class="p-1">
      <div class="layout align-top">
        ...
        <div class="description">
          <p
            v-if="preview.description && size === 'md'"
            class="preline forcebreak mb-0"
          >
            <read-more
          ...
          <p
            v-if="preview.description && size === 'sm'"
            class="preline forcebreak mb-0 small"
          >
            <read-more
              :text="preview.description"
              :max-chars="200"
